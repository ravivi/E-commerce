...
class EvenementList{
  final List<Evenement> listEvents;
  EvenementList({this.listEvents});


  factory EvenementList.fromJson(List<dynamic> json)
  {

    List<Evenement> arr = new List<Evenement>();
    arr = json.map((f)=> Evenement.fromJson(f)).toList();
